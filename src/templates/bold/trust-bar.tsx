const TRUST_ITEMS = [
  {
    ...
    title: "Envío rápido",
    description: "Recibí tu pedido en tiempo récord",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
...
export function TrustBar() {
  return (
    <section className="border-y border-brand-border bg-brand-background py-8">
      <div className="mx-auto grid max-w-7xl grid-cols-2 gap-6 px-4 md:grid-cols-4">
        {TRUST_ITEMS.map((item) => (
          ...
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-brand-surface text-brand-foreground">
              {item.icon}
            </div>
